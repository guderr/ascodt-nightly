...
/**
 * Compiler adapter for generating cxx makefiles
...
public class CreateCxxMakefile extends de.tum.ascodt.sidlcompiler.frontend.analysis.DepthFirstAdapter{
	...
	CreateCxxMakefile(SymbolTable symbolTable, URL userImplementationsDestinationDirectory
	...
	public void inAClassPackageElement(AClassPackageElement node) {
		try {
			...
			String  templateFileForMakefile 						     = "makefile-cxx.template";
			...
			_templateFilesOfMakefile.push(
					new TemplateFile( templateFileForMakefile, destinationFileForMakefile, _namespace, TemplateFile.getLanguageConfigurationForCPP(),false)
					);
