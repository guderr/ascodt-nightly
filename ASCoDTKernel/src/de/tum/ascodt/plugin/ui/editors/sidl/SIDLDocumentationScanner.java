...
public class SIDLDocumentationScanner extends RuleBasedScanner {
	 ...
	 */
	 public SIDLDocumentationScanner(SIDLColorProvider provider) {
		...
		IToken keyword= new Token(new TextAttribute(provider.getColor(SIDLColorProvider.JAVADOC_KEYWORD)));
		IToken tag= new Token(new TextAttribute(provider.getColor(SIDLColorProvider.JAVADOC_TAG)));
		IToken link= new Token(new TextAttribute(provider.getColor(SIDLColorProvider.JAVADOC_LINK)));
